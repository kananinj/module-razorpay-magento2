...
class RefundRequest implements BuilderInterface, RequestInterface {
    ...
    public function build(array $buildSubject) {
        ...
        $requestData = [
            ...
            'speed' => 'normal',
            'notes' => [
                'order_increment_id' => $order->getOrderIncrementId()                
            ]
        ];
        return [
            ...
            self::URL => 'https://api.razorpay.com/v1/payments/'.$rzp_payment_id.'/refund'
        ];
